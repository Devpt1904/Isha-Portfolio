...
export const SendMessageButton = forwardRef<HTMLButtonElement, SendMessageButtonProps>(
  ({ onClick, disabled, isSent }, ref) => {
    return (
      <button
        ref={ref}
        className={`send-message-button w-full ${isSent ? 'is-sent' : ''}`}
        onClick={onClick}
        disabled={disabled}
        type="submit"
      >
        ...
        <div className="state state--default">
          ...
          <p>
            ...
            <span style={{ ['--i' as any]: 5 }}>M</span>
            <span style={{ ['--i' as any]: 6 }}>e</span>
            <span style={{ ['--i' as any]: 7 }}>s</span>
            <span style={{ ['--i' as any]: 8 }}>s</span>
            <span style={{ ['--i' as any]: 9 }}>a</span>
            <span style={{ ['--i' as any]: 10 }}>g</span>
            <span style={{ ['--i' as any]: 11 }}>e</span>
          </p>
        </div>
